"""
Train the best LSTM configuration on full training
"""
...
def main():
    print("="*60)
    print("TRAINING BEST LSTM MODEL (Hidden=256)")
    print("="*60)
    ...
    print("\n[4/5] Creating best LSTM model (256 hidden units)...")
    ...
    for epoch in range(NUM_EPOCHS):
        ...
        if val_auc > best_val_auc:
            ...
            patience_counter = 0
            torch.save(model.state_dict(), 'best_lstm_256.pth')
